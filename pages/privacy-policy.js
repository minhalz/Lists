export default function PrivacyPolicy() {
  return (
    <div className="my-12 lg:my-16 mx-auto space-y-6 max-w-[750px] md:text-lg text-white">
      <p>
        <strong>Lists</strong> is committed to providing quality services to you
      ...
      <p>
        The only personal information we collect is your Facebook User Id so we
        can link each list to a specific user.
      </p>
      <h2 className="!mt-10 text-2xl md:text-3xl font-bold text-primary">
      ...
      <p>
        <strong>Lists</strong> will not charge any fee for your access request,
